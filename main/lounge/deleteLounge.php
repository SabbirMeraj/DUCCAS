...
<?php
		...
		$sql = "Update lounge SET Status='Disable' where Lounge_Name= '$_POST[loungeName]'";
      ...
      <div class="form-group">
        ...
        <div class="col-md-6  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
            <input name="loungeName" placeholder="Lounge Name" class="form-control"  type="text" pattern="[a-zA-Z]{3,15}">
          </div>
        </div>
      </div>
