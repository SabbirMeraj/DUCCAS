	...
	$index=0;
   	...
   	for($i=0;$i<count($item);$i++){
		...
		$itemid=$row['Item_ID'];
   		...
   		$amount= $amnt[$index];
		$j=$j+1;
   			$sql = "INSERT INTO order_table( Membership_ID,Item_ID,Lounge_ID,Date,Amount)
	VALUES ('$_POST[membershipId]',$itemid,$loungeid,'$_POST[Date]',$amount)";
											...
											<label class='col-md-4 control-label'>{$row['Item_Name']}</label>
												<div class='col-md-6'>
													<div class='input-group'>
														...
														<input name='item[]'  class='form-control' type='number' placeholder='Amount' >
													</div>
